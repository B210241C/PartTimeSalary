...
<head>
    ...
    <title>Part Time Salary Calculator - Register</title>
                ...
                <div class="col-lg-7">
                    <div class="p-5">
                        ...
                        <form action="{{ route('register') }}" method="POST" class="user">
                            ...
                            <div class="form-group">
                                <input name="pnumber" type="text" class="form-control form-control-user @error('phone number')is-invalid @enderror" id="exampleInputEmail" placeholder="Phone Number">
                                @error('pnumber')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
